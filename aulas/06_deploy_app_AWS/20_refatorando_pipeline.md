...
Nesta aula, finalizei o conteúdo removendo hardcoded do código e substituindo por variáveis, o que melhora a manutenibilidade. Expliquei como usar variáveis de ambiente no main.yml e a importância de não deixar informações soltas no código. Também demonstrei o processo de deploy automatizado, mostrando como acompanhar a execução e a transição entre versões. Ao final, discutimos a visualização de eventos e a importância de monitorar a pipeline.
